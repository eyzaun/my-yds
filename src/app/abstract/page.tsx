...
// Fix the import to use our new unified component
...
export default function AbstractPage() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      'description': 'YDS sınavı için soyut kavramlar, duygular ve felsefi terimleri içeren İngilizce kelime listesi.',
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Abstract Vocabulary</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="rounded-lg shadow-md p-4 mb-6" style={{ backgroundColor: colors.cardBackground, marginBottom: '1.5rem' }}>
            <p style={{ color: colors.text }} className="text-base mb-3">
              Soyut kavramlar, YDS sınavında felsefi metinler, edebiyat incelemeleri, psikoloji ve duygusal analizlerin yer 
              aldığı parçalarda sıkça karşınıza çıkan kelimelerdir. Bu kategori, somut olarak algılanamayan kavramlar, duygular 
              ve zihinsel süreçleri tanımlayan terimleri içerir.
            </p>
            <p style={{ color: colors.text }} className="text-sm">
              Bu kategoride toplam <strong>{vocabulary.abstract_concepts.length}</strong> kelime ve <strong>{questionCount}</strong> test sorusu bulunmaktadır.
            </p>
          ...
          {showQuiz ? (
            <div>
              ...
              <div className="rounded-lg shadow-md p-4 mb-6" style={{ backgroundColor: colors.cardBackground }}>
                <p style={{ color: colors.text }} className="text-sm">
                  Bu test, Soyut Kavramlar kategorisinden {questionCount} soru içermektedir.
                </p>
              </div>
          ...
          {!showQuiz && (
            <div className="rounded-lg shadow-md p-4 mb-6" style={{ backgroundColor: colors.cardBackground, marginTop: '2rem' }}>
              <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>
                YDS&apos;de Soyut Kavramlar
              </h3>
              <p style={{ color: colors.text }} className="mb-3">
                Soyut kavramlar, YDS sınavında özellikle felsefi, edebi ve psikolojik metinlerde karşınıza çıkar. 
                Bu tür kelimelerin anlamlarını bilmek, derin ve karmaşık metinleri anlamanız için kritik öneme sahiptir.
              </p>
              <p style={{ color: colors.text }}>
                Bu kategorideki kelimeleri öğrenirken, felsefe ve psikoloji alanlarındaki temel metinleri 
                okumak, filmlerdeki veya edebiyattaki soyut kavramların nasıl işlendiğini incelemek faydalı olacaktır. 
                Ayrıca, duyguları, düşünceleri ve zihinsel süreçleri tanımlayan kelimeleri günlük hayatta 
                kullanmaya çalışmak, öğrenmenin kalıcılığını artıracaktır.
              </p>
            </div>
          )}
        </div>
      ...
      {/* Fixed AdSense component usage with container */}
      <div id="ad-container-abstract-footer" className="my-8">
        <ClientOnlyAd 
