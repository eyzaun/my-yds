...
export default function HedefSıfatlarPage() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      '@type': 'WebPage',
      'name': 'YDS Hedef Sıfatlar Kelime Listesi',
      'description': 'YDS sınavında hedeflenen önemli sıfatlar.',
    ...
    <div className="min-h-screen pb-16" style={{ backgroundColor: tokens.colors.background.primary }}>
      <Container maxWidth="lg" className="py-8">
        ...
        <Card variant="elevated" className="mb-6">
          <Text className="mb-3">
            YDS sınavında hedeflenen önemli sıfatlar.
          </Text>
        ...
        <Card variant="elevated" className="mt-8">
          <Heading3 className="mb-3">
            Hedef Sıfatlar Hakkında
          </Heading3>
          <Text>
            YDS sınavında hedeflenen önemli sıfatlar. Bu kelimeler YDS sınavında sıkça karşınıza çıkabilir.
          </Text>
        </Card>
      </Container>
      
      <ClientOnlyAd 
        slot="target-adjectives-footer"
        format="auto"
