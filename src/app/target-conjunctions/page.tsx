...
export default function HedefBağlaçlarPage() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      '@type': 'WebPage',
      'name': 'YDS Hedef Bağlaçlar Kelime Listesi',
      'description': 'YDS sınavında hedeflenen önemli bağlaçlar ve geçiş ifadeleri.',
    ...
    <div className="min-h-screen pb-16" style={{ backgroundColor: tokens.colors.background.primary }}>
      <Container maxWidth="lg" className="py-8">
        ...
        <Card variant="elevated" className="mb-6">
          <Text className="mb-3">
            YDS sınavında hedeflenen önemli bağlaçlar ve geçiş ifadeleri.
          </Text>
        ...
        <Card variant="elevated" className="mt-8">
          <Heading3 className="mb-3">
            Hedef Bağlaçlar Hakkında
          </Heading3>
          <Text>
            YDS sınavında hedeflenen önemli bağlaçlar ve geçiş ifadeleri. Bu kelimeler YDS sınavında sıkça karşınıza çıkabilir.
          </Text>
        </Card>
      </Container>
      
      <ClientOnlyAd 
        slot="target-conjunctions-footer"
        format="auto"
