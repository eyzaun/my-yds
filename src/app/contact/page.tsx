...
export default function Contact() {
  ...
  return (
    ...
    >
      <Container maxWidth="md" style={{ paddingTop: tokens.spacing[8], paddingBottom: tokens.spacing[8] }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: tokens.spacing[6] }}>
          <Card variant="elevated">
            ...
            <Text style={{ marginBottom: tokens.spacing[4] }}>
          ...
          <Card variant="elevated">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: tokens.spacing[4] }}>
              <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                <div style={{ flexShrink: 0, marginTop: tokens.spacing[1] }}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    style={{ height: '1.25rem', width: '1.25rem', color: tokens.colors.primary[600] }}
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                ...
                <div style={{ marginLeft: tokens.spacing[3] }}>
                  <Heading3 style={{ fontSize: tokens.typography.fontSize.base }}>E-posta</Heading3>
                  <Text style={{ marginTop: tokens.spacing[1] }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                ...
                <div style={{ marginLeft: tokens.spacing[3] }}>
                  <Heading3 style={{ fontSize: tokens.typography.fontSize.base }}>Instagram</Heading3>
                  <Text style={{ marginTop: tokens.spacing[1] }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                ...
                <div style={{ marginLeft: tokens.spacing[3] }}>
                  <Heading3 style={{ fontSize: tokens.typography.fontSize.base }}>Kick</Heading3>
                  <Text style={{ marginTop: tokens.spacing[1] }}>
