...
export default function TemelZarflarPage() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      '@type': 'WebPage',
      'name': 'YDS Temel Zarflar Kelime Listesi',
      'description': 'YDS için temel düzey önemli zarflar.',
    ...
    <div className="min-h-screen pb-16" style={{ backgroundColor: tokens.colors.background.primary }}>
      <Container maxWidth="lg" className="py-8">
        ...
        <Card variant="elevated" className="mb-6">
          <Text className="mb-3">
            YDS için temel düzey önemli zarflar.
          </Text>
        ...
        <Card variant="elevated" className="mt-8">
          <Heading3 className="mb-3">
            Temel Zarflar Hakkında
          </Heading3>
          <Text>
            YDS için temel düzey önemli zarflar. Bu kelimeler YDS sınavında sıkça karşınıza çıkabilir.
          </Text>
        </Card>
      </Container>
      
      <ClientOnlyAd 
        slot="basic-adverbs-footer"
        format="auto"
