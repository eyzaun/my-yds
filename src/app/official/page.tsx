      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="rounded-lg shadow-md p-4 mb-6" style={{ backgroundColor: colors.cardBackground, marginBottom: '1.5rem' }}>
          <p style={{ color: colors.text }} className="text-base mb-3">
            Resmi dil kelimeleri, akademik yazılarda, bürokratik metinlerde, hukuki belgelerde ve profesyonel iletişimde 
        ...
        {!showQuiz && (
          <div className="rounded-lg shadow-md p-4 mb-6" style={{ backgroundColor: colors.cardBackground, marginTop: '2rem' }}>
            <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>
              YDS&apos;de Resmi Dil Önemi
            </h3>
            <p style={{ color: colors.text }} className="mb-3">
            Resmi dil kullanımı, YDS sınavında özellikle akademik metinler, uluslararası anlaşmalar, hukuki dokümanlar 
              ve resmi yazışmalar gibi içeriklerde karşınıza çıkar. Bu tür metinlerde kullanılan kelimeler genellikle 
              günlük dile göre daha formal ve teknik özellikler taşır.
            </p>
            <p style={{ color: colors.text }}>
              Bu kategoriyi çalışırken, uluslararası kuruluşların (Birleşmiş Milletler, Dünya Sağlık Örgütü, vb.) 
              resmi belgelerini, akademik makalelerin özetlerini ve hukuki metinleri incelemek faydalı olacaktır. 
              Ayrıca resmi mektup ve dilekçe formatlarını öğrenmek de bu kategorideki kelimeleri bağlamında görmenizi sağlayacaktır.
            </p>
          </div>
        )}
      </div>
