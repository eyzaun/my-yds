...
export default function TemelBağlaçlarPage() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      '@type': 'WebPage',
      'name': 'YDS Temel Bağlaçlar Kelime Listesi',
      'description': 'YDS için temel düzey bağlaçlar ve geçiş ifadeleri.',
    ...
    <div className="min-h-screen pb-16" style={{ backgroundColor: tokens.colors.background.primary }}>
      <Container maxWidth="lg" className="py-8">
        ...
        <Card variant="elevated" className="mb-6">
          <Text className="mb-3">
            YDS için temel düzey bağlaçlar ve geçiş ifadeleri.
          </Text>
        ...
        <Card variant="elevated" className="mt-8">
          <Heading3 className="mb-3">
            Temel Bağlaçlar Hakkında
          </Heading3>
          <Text>
            YDS için temel düzey bağlaçlar ve geçiş ifadeleri. Bu kelimeler YDS sınavında sıkça karşınıza çıkabilir.
          </Text>
        </Card>
      </Container>
      
      <ClientOnlyAd 
        slot="basic-conjunctions-footer"
        format="auto"
