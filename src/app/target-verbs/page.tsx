...
export default function HedefFiillerPage() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      '@type': 'WebPage',
      'name': 'YDS Hedef Fiiller Kelime Listesi',
      'description': 'YDS sınavında hedeflenen önemli fiiller.',
    ...
    <div className="min-h-screen pb-16" style={{ backgroundColor: tokens.colors.background.primary }}>
      <Container maxWidth="lg" className="py-8">
        ...
        <Card variant="elevated" className="mb-6">
          <Text className="mb-3">
            YDS sınavında hedeflenen önemli fiiller.
          </Text>
        ...
        <Card variant="elevated" className="mt-8">
          <Heading3 className="mb-3">
            Hedef Fiiller Hakkında
          </Heading3>
          <Text>
            YDS sınavında hedeflenen önemli fiiller. Bu kelimeler YDS sınavında sıkça karşınıza çıkabilir.
          </Text>
        </Card>
      </Container>
      
      <ClientOnlyAd 
        slot="target-verbs-footer"
        format="auto"
