    ...
    <div className="min-h-screen pb-16" style={{ backgroundColor: designTokens.colors.background.primary }}>
      ...
      <Container maxWidth="lg" className="py-8">
        ...
        <Card variant="elevated" className="mb-6">
          <Text className="mb-3">
            Bağlaçlar ve geçiş ifadeleri, İngilizce metinlerde fikirler ve cümleler arasında bağlantı kurmak için kullanılan
            önemli kelimelerdir. YDS sınavında cümleleri doğru anlayabilmek ve paragraf sorularını çözebilmek için bu
            kelimelerin işlevlerini bilmek kritik öneme sahiptir.
          </Text>
          <Text style={{ fontSize: designTokens.typography.fontSize.sm }}>
            Bu kategoride toplam <strong>{vocabulary.conjunctions_and_transitions.length}</strong> kelime ve <strong>{questionCount}</strong> test sorusu bulunmaktadır.
          </Text>
        ...
        {showQuiz ? (
          <div>
            ...
            <Card variant="elevated" className="mb-6">
              <Text style={{ fontSize: designTokens.typography.fontSize.sm }}>
                Bu test, Bağlaçlar kategorisinden {questionCount} soru içermektedir.
              </Text>
            </Card>
        ...
        {!showQuiz && (
          <Card variant="elevated" className="mt-8">
            <Heading3 className="mb-3">
              YDS&apos;de Bağlaçların Önemi
            </Heading3>
            <Text className="mb-3">
              Bağlaçlar (conjunctions) ve geçiş ifadeleri (transition words), YDS sınavında metinlerin ana fikrini,
              dönüm noktalarını ve fikir akışını anlamak için çok önemlidir. Özellikle paragraf tamamlama, metin bütünlüğü
              ve anlam ilişkilerini sorgulayan sorularda bu kelimeler kilit rol oynar.
            </Text>
            <Text>
              Bağlaçları işlevlerine göre gruplandırarak çalışmak daha etkilidir. Örneğin; zıtlık belirtenler (however, nevertheless),
              sebep-sonuç ilişkisi kuranlar (therefore, consequently), eklemeleri gösterenler (furthermore, moreover) gibi
              kategorilere ayırarak öğrenmek, metin içindeki işlevlerini daha iyi anlamanızı sağlar.
            </Text>
          </Card>
        )}
      </Container>
