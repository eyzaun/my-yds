...
export const categories: Category[] = [
  ...
  {
    name: 'Hedef Bağlaçlar',
    path: '/target-conjunctions',
  ...
  {
    name: 'Çevre ve Biyoloji',
    path: '/environment-biology',
...
export const features: Feature[] = [
  {
    ...
    description: "18 farklı kategoride düzenlenmiş YDS kelimeleri",
    icon: (
  ...
  },
  {
    ...
    description: "Her kategori için kelime kartları ile etkili öğrenme",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
